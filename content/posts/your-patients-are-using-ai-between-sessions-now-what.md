---
title: "Your Patients Are Using AI Between Sessions. Now What?"
date: 2026-07-15T15:12:21.741320+00:00
draft: false
description: "Your patients are using AI between sessions. Discover how to address AI use in therapy, set boundaries, and integrate it into your clinical practice effectively"
image: "/img/heroes/7641009.jpg"
categories: ["trending"]
tags: ["your", "patients", "using", "between", "sessions."]
author: "Kim Davis"
...
slug: "your-patients-are-using-ai-between-sessions-now-what"
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">What psychologists are seeing in patients using AI for mental health</div><div class="sc-row"><span class="sc-label">Used AI for support</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">77%</span></div><div class="sc-row"><span class="sc-label">Self-diagnosed via AI</span><span class="sc-track"><span class="sc-bar" style="width:51%"></span></span><span class="sc-val">39%</span></div><div class="sc-row"><span class="sc-label">Appeared chatbot-dependent</span><span class="sc-track"><span class="sc-bar" style="width:47%"></span></span><span class="sc-val">36%</span></div><div class="sc-row"><span class="sc-label">Developed delusional beliefs</span><span class="sc-track"><span class="sc-bar" style="width:19%"></span></span><span class="sc-val">15%</span></div><div class="sc-row"><span class="sc-label">Formed intimate AI connection</span><span class="sc-track"><span class="sc-bar" style="width:17%"></span></span><span class="sc-val">13%</span></div><div class="sc-src">Source: APA 2026 Chatbots and Mental Health Survey</div></div>
...
You might be wondering: if people are using AI to talk about their mental health, isn't that still better than saying nothing at all? It's a fair question, and the honest answer is: sometimes yes, sometimes no, and the "no" cases are more concerning than we first assumed.
...
The [APA Monitor's March 2026 piece on AI in the therapist's office](https://www.apa.org/monitor/2026/03/ai-reshaping-therapy) noted that uptake of AI-adjacent tools is increasing even among cautious clinicians, but so is concern about appropriate use. The field is genuinely grappling with where these tools fit.
...
The practical upshot of the APA's June 2026 findings, as covered in detail at [HealthPopuli](http://www.healthpopuli.com/2026/06/17/most-psychologists-say-their-patients-use-ai-for-mental-health-support-recommendations-on-chatbotsand-ai-from-the-apa/), is that intake conversations and treatment planning now reasonably include questions about AI use. Not as an interrogation, but as a normal part of understanding how a patient is coping between sessions.
...
- [APA – Patients Are Bringing AI to Therapy (2026 Chatbots and Mental Health Survey)](https://www.apa.org/pubs/reports/chatbots-mental-health-2026) (June 2026)
- [APA Press Release – Psychologists Say Patients Are Turning to Chatbots as Mental Health Professionals](https://www.apa.org/news/press/releases/2026/06/patients-chatbots-mental-health) (June 16, 2026)
- [HealthPopuli – Most Psychologists Say Their Patients Use AI for Mental Health Support](http://www.healthpopuli.com/2026/06/17/most-psychologists-say-their-patients-use-ai-for-mental-health-support-recommendations-on-chatbotsand-ai-from-the-apa/) (June 17, 2026)
- [Earth.com – Many People Are Turning to AI Chatbots for Mental Health Support](https://www.earth.com/news/millions-of-people-are-turning-to-ai-chatbots-for-mental-health-support/) (June 2026)
- [Brilo AI – AI in Mental Health & Therapy Statistics (2026)](https://www.brilo.ai/resources/ai-therapist-statistics) (June 13, 2026)
- [APA Monitor – AI in the Therapist's Office: Uptake Increases, Caution Persists](https://www.apa.org/monitor/2026/03/ai-reshaping-therapy) (March 2026)
