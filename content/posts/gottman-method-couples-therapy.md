...
faqs:
  - q: "How do I know if my relationship is worth saving with Gottman therapy?"
    a: "That's not what Gottman method answers. A therapist can tell you whether the patterns are repairable, but only you can decide if you want to repair them. If you're both willing to try and you're not in an unsafe situation, Gottman gives you concrete tools. If one or both of you have already checked out emotionally, no method will fix that."
  - q: "Can Gottman therapy work if we're doing it partially, like just learning the techniques?"
    a: "Partially helpful, but not ideal. The real work is understanding why you fall into these patterns in the first place. Learning softened startup without addressing the contempt underneath it is like treating a symptom. A therapist helps you see the roots and interrupt both the pattern and what feeds it."
  - q: "Is Gottman method better than other couples therapy approaches?"
    a: "The research on Gottman is strong for specific problems (poor communication, contempt, defensiveness, stonewalling). Other approaches work well for different issues: imago therapy if you're trying to understand unmet childhood needs, Emotionally Focused Therapy (EFT) if you're dealing with emotional disconnection, or Discernment Counseling if one person is questioning whether to stay. Gottman isn't universally best. It's best for what it's designed to fix."
...
- [The Gottman Institute Research](https://www.gottman.com/about/research/): The official institute publishing decades of longitudinal research on predictors of divorce and what interventions work.
- [Gottman, J. M., & Gottman, J. S. (2017). The New Rules of Marriage](https://www.gottman.com/): The foundational book on the method, readable and research-grounded.
- [Journal of Family Psychology studies on Gottman method efficacy](https://www.apa.org/pubs/journals/fam): Peer-reviewed research validating outcomes.
- [Psychology Today Therapist Directory](https://www.psychologytoday.com/): Filters by approach (including Gottman) and location, though double-check credentials separately.
- [SAMHSA's treatment locator](https://findtreatment.gov/): If you need broader mental health support resources, including couples therapy in your area.
