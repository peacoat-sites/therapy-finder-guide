...
faqs:
  - q: "How long does therapy for depression usually take?"
    a: "There's no universal answer, which is frustrating but true. Structured therapies like CBT often show measurable improvement within 8 to 12 sessions. Some people feel meaningfully better after 6. Others with chronic or treatment-resistant depression may benefit from longer-term work. The honest answer is to reassess with your therapist after 8 sessions and ask directly whether you're making progress."
  - q: "Can online therapy work just as well as in-person therapy for depression?"
    a: "For many people, yes. A 2021 meta-analysis published in World Psychiatry found that video-based CBT produced outcomes comparable to face-to-face delivery for depression. Platforms like Telehealth services through your insurance, or directories like Psychology Today's online filter, can connect you with licensed therapists remotely. That said, severe depression or co-occurring conditions may call for more intensive, in-person care. Talk to a provider about what fits your situation."
  - q: "What should I do if I can't afford therapy right now?"
...
Here's a step-by-step process designed for when you're running on empty.

**Step 1: Start with your insurance (or a cost alternative).** Call the member services number on the back of your insurance card and ask for a list of in-network therapists who specialize in depression and are accepting new patients. Write down three names. Three is enough. If you don't have insurance, Psychology Today's therapist finder lets you filter by sliding-scale fees, and the [National Alliance on Mental Illness (NAMI)](https://www.nami.org/) offers a helpline (1-800-950-NAMI) that can connect you with local resources and low-cost options.

**Step 2: Send emails, not calls.** Phone anxiety is real, especially with depression. Most therapists list an email on their profile. Write one sentence: "I'm looking for a therapist who works with depression. Do you have availability?" That's it. You don't have to explain your whole situation.
...
| Therapy Type | Session Structure | Best For | Typical Length |
|---|---|---|---|
| CBT | Highly structured, skills-focused | Mild to moderate depression, negative thought patterns | 12-20 sessions |
| Behavioral Activation | Activity scheduling, practical | Withdrawal and low motivation | 8-15 sessions |
| IPT | Semi-structured, relationship-focused | Grief, transitions, relationship conflict | 12-16 sessions |
| Psychodynamic | Open-ended, exploratory | Chronic or identity-rooted depression | Months to years |
| ACT | Mindfulness-based, values-focused | Avoiding difficult emotions, rigid thinking | 8-16 sessions |
...
**"I'll have to talk about my childhood."** Only if it's relevant and only if you choose to. Modern therapies like CBT and ACT are very much focused on the present. You're not obligated to trace everything back to age seven.
...
**"What if it doesn't work?"** This is the depression talking, partly. But it's also a fair question. Therapy doesn't work for everyone on the first try with the first therapist. It sometimes takes switching modalities or providers. That's not failure; that's the process.
