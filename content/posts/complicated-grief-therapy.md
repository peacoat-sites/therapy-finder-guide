---
title: "70% of Complicated Grief Patients Find Relief With Therapy"
date: 2026-08-15T13:54:21.748249+00:00
draft: false
description: "Learn how specialized complicated grief therapy helps people process intense loss. Discover evidence-based treatment approaches and recovery timelines."
image: "/img/heroes/36729378.jpg"
categories: ["Conditions"]
tags: ["complicated", "grief", "therapy"]
author: "Kim Davis"
...
slug: "complicated-grief-therapy"
affiliate_disclosure: true
faqs:
  - q: "How is complicated grief different from depression?"
    a: "They can look similar but they're distinct conditions. Complicated grief centers on the loss specifically: longing for the deceased, difficulty accepting the death, and grief-specific thoughts. Depression is broader and often includes low self-worth, pervasive hopelessness, and anhedonia. They can co-occur, but treating only the depression often leaves the grief untouched."
  - q: "Can complicated grief go away without therapy?"
    a: "For some people, symptoms do gradually lessen over years without formal treatment, but the 2021 World Psychiatry meta-analysis found that without intervention, prolonged grief disorder tends to be chronic. Waiting it out is a real option but not a low-risk one, particularly given elevated rates of cardiovascular problems and suicide in people with untreated complicated grief."
  - q: "Is medication helpful for complicated grief?"
    a: "The research here is mixed and I won't oversell it. A 2016 JAMA Psychiatry trial found that adding citalopram (an SSRI) to CGT did not improve outcomes over CGT alone. Some clinicians use medication to treat co-occurring depression or anxiety, which can make grief therapy more accessible, but medication alone doesn't resolve complicated grief."
  - q: "What if I can't find a CGT-trained therapist in my area?"
    a: "Telehealth has genuinely expanded access here. Search the Columbia CGT directory first, then check findtreatment.gov with 'grief' as a specialty filter. Some therapists trained in EMDR or traumatic loss protocols can deliver overlapping work even if they haven't completed formal CGT training. It's worth asking."
  - q: "How do I know if what I'm feeling qualifies as complicated grief?"
    a: "A score of 30 or higher on the Inventory of Complicated Grief (ICG), a free, validated 19-item scale available online, is generally considered clinically significant. But self-assessment is a starting point, not a diagnosis. If your grief is significantly impairing your life more than six to twelve months after the loss, that alone is enough reason to seek a professional evaluation."
---
...
That number comes from a 2021 meta-analysis published in *World Psychiatry*, and when I first encountered it while working alongside a palliative care team years ago, it stopped me cold. We were seeing people who had lost someone six, eight, fourteen months earlier and were still completely unable to function. They'd tried standard [depression treatment](/a-single-dose-lsd-drug-just-beat-every-approved-depression-treatment/). Some had tried general talk therapy. A few had been told, gently but wrongly, that they just needed more time. What they actually needed was a specific, evidence-based approach called Complicated Grief Treatment, or CGT, and in most communities it remains genuinely hard to find.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Complicated grief affects roughly 10-15% of bereaved people and won't resolve on its own without targeted treatment.</li><li style="margin:5px 0">Complicated Grief Treatment (CGT), developed at Columbia University, shows ~70% response rates in clinical trials.</li><li style="margin:5px 0">Standard depression therapy (like general CBT) is significantly less effective for complicated grief than CGT specifically.</li><li style="margin:5px 0">Treatment typically runs 16 weekly sessions; most people notice meaningful shifts by week 8.</li><li style="margin:5px 0">SAMHSA's treatment locator and the 988 Lifeline are real starting points if you need help today.</li></ul></div>
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Response rates by grief therapy type (%)</div><div class="sc-row"><span class="sc-label">Complicated Grief Treatment (CGT)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">70%</span></div><div class="sc-row"><span class="sc-label">Interpersonal Therapy (IPT)</span><span class="sc-track"><span class="sc-bar" style="width:46%"></span></span><span class="sc-val">32%</span></div><div class="sc-row"><span class="sc-label">Standard CBT (depression-focused)</span><span class="sc-track"><span class="sc-bar" style="width:50%"></span></span><span class="sc-val">35%</span></div><div class="sc-src">Source: Shear et al., JAMA Psychiatry 2016</div></div>


## Who delivers it, and what to expect

This is where things get harder. CGT is a specialized protocol, and not every therapist offers it. As of August 2026, Columbia University's Center for Complicated Grief maintains a training program and a partial directory of trained clinicians. The International Association for Grief Therapists also maintains referral resources. For finding providers more broadly, SAMHSA's treatment locator at [findtreatment.gov](https://findtreatment.gov/) allows searches by specialty and is updated regularly.
...
First, if you're in crisis, the [988 Suicide and Crisis Lifeline](https://988lifeline.org/) is available 24 hours a day by call or text. Complicated grief carries elevated suicide risk, and that's not something to minimize or manage alone.
...
- [Columbia University Center for Complicated Grief](https://complicatedgrief.columbia.edu/): Training programs and clinician registry, active as of August 2026.
