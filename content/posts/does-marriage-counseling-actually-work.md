...
Domestic violence gets trickier. Most couples therapists screen for it, and most ethical ones decline to do conjoint therapy when there's coercive control or physical danger. Couples therapy in a domestic violence context can actually make things worse by giving an abusive partner new language to manipulate with. If this applies to you, [NAMI](https://www.nami.org/) has resources that point toward appropriate support, and calling the [988 Suicide and Crisis Lifeline](https://988lifeline.org/) is an option if things feel dangerous.
