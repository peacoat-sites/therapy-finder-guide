...
Structured workbooks can be meaningful, particularly ones grounded in Cognitive Behavioral Therapy (CBT). "Mind Over Mood" by Christine Padesky and Dennis Greenberger has been in print since 1995 and is consistently recommended by therapists themselves as a between-sessions tool. You can find it on [Amazon](https://amzn.to/3Q5v0EV) for around $20. It's not a replacement for therapy, and I'd never frame it that way. But it's a real resource, not just a self-help book.
