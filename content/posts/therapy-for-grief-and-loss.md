...
faqs:
  - q: "How long does grief therapy typically take?"
    a: "It depends on the type of loss and the presence of complications. Structured programs like CGT typically run 16 sessions over about four months. Grief without the 'complicated' qualifier may resolve meaningfully in 8 to 12 sessions, though many people continue longer for support."
  - q: "Is grief therapy different from regular talk therapy?"
    a: "Yes, meaningfully so. Generic supportive therapy can help, but grief-specific approaches like CGT use structured protocols, including techniques like imaginal revisiting, that standard supportive counseling doesn't include. If you've tried regular therapy for grief without progress, asking specifically about grief-trained therapists is worth it."
  - q: "Can therapy help even if the loss happened years ago?"
    a: "Absolutely, and this is one area where I'd push back on the cultural assumption that you 'should be over it' by a certain point. Prolonged or complicated grief can persist for years and still responds well to treatment. There's no expiration date on seeking help."
  - q: "What's the difference between grief and depression, and why does it matter for treatment?"
...
- [SAMHSA's treatment locator](https://findtreatment.gov/): Free database for finding licensed mental health professionals, including those with sliding scale or Medicaid access.
- [988 Suicide and Crisis Lifeline](https://988lifeline.org/): 24/7 support for acute distress, available by call or text.
