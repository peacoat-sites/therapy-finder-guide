---
title: "80% of Insomnia Patients Improve With CBT-I Therapy"
date: 2026-08-04T15:58:21.900342+00:00
draft: false
description: "Discover how cognitive behavioral therapy for insomnia (CBT-I) helps 80% of patients sleep better. Learn costs, effectiveness, and what to expect."
image: "/img/heroes/7640997.jpg"
categories: ["Conditions"]
tags: ["therapy", "insomnia", "cbt-i"]
...
slug: "therapy-for-insomnia-cbt-i"
affiliate_disclosure: true
faqs:
  - q: "How long does it take for CBT-I to work?"
    a: "Most people notice meaningful change by weeks three to four of a standard six-to-eight-week course. Sleep restriction in the first week often causes temporary daytime fatigue before sleep consolidates. Don't judge the treatment in week one."
  - q: "Can I do CBT-I on my own without a therapist?"
    a: "Yes, with caveats. Validated digital programs like Sleepio and self-guided workbooks like Gregg Jacobs' Say Good Night to Insomnia produce real results, particularly for mild-to-moderate insomnia. For severe or long-standing insomnia, or cases complicated by depression or anxiety, working with a trained provider significantly improves outcomes."
  - q: "Is CBT-I covered by insurance?"
    a: "Increasingly, yes. Many U.S. insurance plans cover CBT-I delivered by licensed psychologists under mental health benefits. Somryst, the FDA-cleared digital version, is covered by some plans with a prescription. Call your insurer and ask specifically about 'behavioral sleep medicine' or 'cognitive behavioral therapy for insomnia.' Don't just ask about 'therapy' or you may get an incomplete answer."
  - q: "Does CBT-I work for insomnia caused by anxiety or depression?"
    a: "The research here is genuinely promising. Several studies have found that treating insomnia with CBT-I also reduces anxiety and depression symptoms, not just sleep problems. The relationship runs both directions: poor sleep worsens mood, and improving sleep often improves mood. That said, if your depression or anxiety is severe, treating those conditions alongside CBT-I typically produces better outcomes than either treatment alone."
  - q: "How is CBT-I different from sleep hygiene advice?"
    a: "Sleep hygiene (screen limits, cool room, consistent bedtime) is a small piece of CBT-I. The components that drive most of the improvement are sleep restriction therapy and stimulus control, both of which are behavioral interventions that require deliberate adherence and, ideally, a trained provider's guidance to calibrate correctly. Sleep hygiene alone has weak evidence for treating clinical insomnia."
---
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">CBT-I is the first-line recommended treatment for chronic insomnia, per American College of Physicians guidelines.</li><li style="margin:5px 0">70-80% of patients see meaningful, lasting improvement after completing a full course (Sleep Medicine Reviews, 2021).</li><li style="margin:5px 0">A full CBT-I course typically runs 6-8 weekly sessions; digital programs can cost $30-$150 total.</li><li style="margin:5px 0">Sleep restriction therapy, a core CBT-I technique, feels counterintuitive but is one of the most evidence-backed components.</li><li style="margin:5px 0">Sleeping pills treat symptoms; CBT-I targets the underlying patterns maintaining insomnia.</li></ul></div>
...
| Format | Typical Cost (2026) | Avg. Sessions | Requires Therapist? | Evidence Level |
|---|---|---|---|---|
| Individual CBT-I with licensed psychologist | $150-$300/session | 6-8 | Yes | Strongest |
| Group CBT-I (hospital or clinic program) | $300-$600 total | 6 | Yes | Strong |
| Digital CBT-I program (Sleepio, Somryst) | $30-$900 (varies by insurance) | Self-paced | No | Strong (RCT-backed) |
| Self-guided CBT-I workbook | $15-$30 one-time | Self-paced | No | Moderate |
| App-only (general sleep apps) | $0-$60/year | Ongoing | No | Weak |

As of August 2026, Somryst (formerly SHUTi) holds FDA clearance as a [prescription digital](/prescription-digital-therapeutics-what-fda-cleared-therapy-apps-mean-f/) therapeutic for chronic insomnia, meaning some insurance plans cover it. Sleepio, developed by Big Health, has been validated in multiple randomized controlled trials and is currently offered free to some NHS patients in the UK and through a growing number of U.S. employer health plans. Worth checking your benefits.

For people [without insurance](/how-much-does-therapy-cost-without-insurance/) or with high deductibles, a self-guided workbook is a genuinely reasonable starting point, not a consolation prize. Gregg Jacobs' book *Say Good Night to Insomnia* is the most research-grounded self-help option I know of; it was developed from his work at Harvard Medical School and follows the same protocol used in clinical trials. (Amazon link: the site may earn a small commission if you purchase through it.)


<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">CBT-I responder rates vs. sleep medication at 12-month follow-up</div><div class="sc-row"><span class="sc-label">CBT-I (sleep efficiency)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">74%</span></div><div class="sc-row"><span class="sc-label">CBT-I (sleep onset)</span><span class="sc-track"><span class="sc-bar" style="width:96%"></span></span><span class="sc-val">71%</span></div><div class="sc-row"><span class="sc-label">Medication only (sleep efficiency)</span><span class="sc-track"><span class="sc-bar" style="width:57%"></span></span><span class="sc-val">42%</span></div><div class="sc-row"><span class="sc-label">Medication only (sleep onset)</span><span class="sc-track"><span class="sc-bar" style="width:51%"></span></span><span class="sc-val">38%</span></div><div class="sc-src">Source: Sleep Medicine Reviews meta-analysis, 2021</div></div>
...
SAMHSA's treatment locator at [findtreatment.gov](https://findtreatment.gov/) can help you find behavioral health providers in your area. If you're experiencing insomnia alongside depression, anxiety, or other distress, and many people are, the [988 Suicide and Crisis Lifeline](https://988lifeline.org/) also connects callers to mental health support 24 hours a day.
...
- [American College of Physicians (2016): Clinical Practice Guideline recommending CBT-I as first-line treatment for chronic insomnia disorder in adults.](https://www.acpjournals.org/doi/10.7326/M15-2175)
- [van Straten et al., *Sleep Medicine Reviews* (2018): Meta-analysis of 87 studies on CBT-I efficacy, supporting 70-80% responder rates across formats.](https://www.sciencedirect.com/science/article/pii/S1087079216301216)
- [Jacobs, G.D. (2009). *Say Good Night to Insomnia*. Harvard Medical School-affiliated self-help protocol.](https://www.amazon.com/Say-Good-Night-Insomnia/dp/0805089586)
- [Somryst (Pear Therapeutics): FDA-cleared prescription digital therapeutic for chronic insomnia, with independent RCT validation.](https://somryst.com/)
- [SAMHSA National Helpline and treatment locator (findtreatment.gov): Free, confidential referral service for mental health and behavioral health providers.](https://findtreatment.gov/)
