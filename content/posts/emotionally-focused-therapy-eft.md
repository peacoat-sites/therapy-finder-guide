...
faqs:
  - q: "How long does EFT therapy usually take?"
    a: "Most couples complete EFT in 8-20 sessions, though this varies based on how entrenched the patterns are and whether individual trauma is part of the picture. Individual EFT (EFIT) often runs a similar length, sometimes longer if deeper attachment wounds are being addressed."
  - q: "Is EFT the same as EMDR?"
    a: "No, they're different approaches with different targets. EMDR (Eye Movement Desensitization and Reprocessing) is primarily used for trauma processing. EFT is focused on attachment bonds and emotional experience within relationships. Some therapists are trained in both and may integrate elements, but they're distinct modalities."
  - q: "Can EFT work over video sessions?"
    a: "It can, and many therapists successfully practice EFT via telehealth. The honest caveat is that the research specifically comparing telehealth EFT outcomes to in-person EFT is limited. Some therapists feel that reading nonverbal cues is harder over video, which matters in this particular approach. It's worth discussing with any therapist you're considering."
  - q: "How do I know if my therapist is actually trained in EFT?"
...
- [International Centre for Excellence in Emotionally Focused Therapy (ICEEFT)](https://iceeft.com): The certifying body for EFT therapists; maintains a public therapist directory.
- [National Alliance on Mental Illness (NAMI)](https://www.nami.org): General mental health resources and crisis support, including guidance on safety planning.
