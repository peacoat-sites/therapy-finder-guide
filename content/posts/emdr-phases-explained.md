---
title: "EMDR Phases Explained: 8 Steps to Trauma Recovery"
date: 2026-08-08T14:08:25.244175+00:00
draft: false
description: "Learn the 8 phases of EMDR therapy, from history-taking to closure. Understand how each step helps process traumatic memories."
image: "/img/heroes/4100433.jpg"
categories: ["Therapy Types"]
tags: ["emdr", "phases", "explained"]
author: "Alex Morgan"
...
slug: "emdr-phases-explained"
affiliate_disclosure: true
faqs:
  - q: "Do the eye movements actually do anything, or is that just a gimmick?"
    a: "The research here is genuinely interesting and still somewhat contested. The bilateral stimulation does appear to matter, not just the exposure to difficult memories. A 2013 meta-analysis in the Journal of Anxiety Disorders found that EMDR with eye movements outperformed EMDR without them, though effect sizes varied. The leading hypothesis involves something called working memory taxation: tracking the bilateral stimulus while holding a memory in mind reduces the vividness and emotional charge of that memory. It's not magic, and it's not fully explained yet, but it's not theatrical either."
  - q: "Can I do EMDR for anxiety or depression even if I don't have a trauma history?"
    a: "Yes, though it's less studied in those contexts. EMDR was developed for PTSD, and that's still where the evidence base is strongest. Some therapists use adapted EMDR protocols for phobias, OCD, and grief with promising results. If your anxiety doesn't have identifiable experiential roots, your therapist may find it's a shorter course or may blend EMDR with other approaches."
  - q: "What if I can't 'see' memories clearly or I dissociate during sessions?"
    a: "This is more common than people expect, and a well-trained EMDR therapist will know how to work with it. Dissociation during processing is one reason Phase 2 (preparation) is so important; building stabilization skills first gives you something to return to. Therapists trained in the 'EMDR with dissociation' specialty (often called the 'Trauma Recovery' model) use modified approaches that slow everything down considerably. Don't let this stop you from asking a prospective therapist how they handle it."
  - q: "Is EMDR covered by insurance?"
    a: "As of August 2026, most major U.S. insurers cover EMDR when it's billed under PTSD or another qualifying diagnosis, because EMDR sessions are coded the same as standard psychotherapy (typically CPT codes 90837 or 90834). What varies is whether your specific plan covers mental health at all, your co-pay, and whether the therapist is in-network. Call your insurer before booking and ask specifically about outpatient psychotherapy coverage, not 'EMDR' by name, because most billing reps won't know what that is."
  - q: "How do I know if my therapist is actually trained in EMDR versus just saying they are?"
    a: "EMDRIA-certified therapists have completed a minimum of 20 hours of supervised practice beyond their basic training. The EMDRIA website lets you search for certified practitioners by zip code. Basic EMDR training (without certification) is a two-weekend intensive and doesn't include that supervised component. It doesn't mean a non-certified therapist is bad, but certification is a meaningful signal of investment in the modality. Worth asking directly: 'Are you EMDRIA-certified, or EMDRIA-approved for basic training?'"
---

Most people who end up researching EMDR have already tried something else. Maybe [talk therapy](/how-does-talk-therapy-change-the-brain/) helped, but only so far. Maybe they've been in and out of CBT for a couple of years, working hard, doing the journaling and the thought records, and still find themselves jolting awake at 2 a.m. from the same nightmare. If that's you right now, you're not broken and you're not beyond help. You're just not done yet.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">EMDR has 8 distinct phases; most clients spend multiple sessions in phases 3-6 before completing treatment.</li><li style="margin:5px 0">Bilateral stimulation (eye movements, tapping, or audio tones) is used only in phases 4-6, not the entire process.</li><li style="margin:5px 0">Trauma processing doesn't begin until the therapist confirms the client has adequate coping skills, usually in phase 2.</li><li style="margin:5px 0">A single EMDR course can range from 3 sessions for a single-incident trauma to 2+ years for complex trauma histories.</li><li style="margin:5px 0">EMDR is recognized by the WHO, VA, and APA as an evidence-based treatment for PTSD.</li></ul></div>
...
One thing only someone inside this process would notice: the [first session](/questions-to-ask-a-therapist-before-first-session/) often ends and you think, "we didn't do anything yet." That feeling is normal and it's actually a good sign. It means your therapist isn't rushing.
...
For finding a trained EMDR therapist, the EMDR International Association's directory is the most reliable starting point, and [SAMHSA's treatment locator](https://findtreatment.gov/) can help if cost or access is a barrier. [Psychology Today's therapist directory](https://www.psychologytoday.com/us/therapists) also lets you filter specifically by EMDR as a specialty.

If you're doing EMDR work and your therapist has recommended [journaling between](/journaling-between-therapy-sessions/) sessions, something like *The PTSD Workbook* by Mary Beth Williams and Soili Poijula can be genuinely useful as a companion (affiliate link; the site may earn a small commission if you purchase through it). I'd be cautious about using it as a substitute for therapy, but as a supplement to structured EMDR work, it holds up.


<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Estimated EMDR session ranges by trauma type</div><div class="sc-row"><span class="sc-label">Single-incident adult</span><span class="sc-track"><span class="sc-bar" style="width:11%"></span></span><span class="sc-val">8 sessions</span></div><div class="sc-row"><span class="sc-label">Single-incident childhood</span><span class="sc-track"><span class="sc-bar" style="width:19%"></span></span><span class="sc-val">14 sessions</span></div><div class="sc-row"><span class="sc-label">Combat PTSD</span><span class="sc-track"><span class="sc-bar" style="width:40%"></span></span><span class="sc-val">30 sessions</span></div><div class="sc-row"><span class="sc-label">Complex/developmental</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">75 sessions</span></div><div class="sc-row"><span class="sc-label">Phobia only</span><span class="sc-track"><span class="sc-bar" style="width:5%"></span></span><span class="sc-val">4 sessions</span></div><div class="sc-src">Source: EMDR International Association clinical guidelines, 2024</div></div>


## Sources

- [EMDR International Association (EMDRIA)](https://www.emdria.org): Professional organization for EMDR practitioners; publishes training standards and research guidelines
...
- [World Health Organization (2013). Guidelines for the Management of Conditions Specifically Related to Stress](https://www.who.int/publications/i/item/9789241505406): Recommends EMDR as a first-line treatment for PTSD in adults
...
- [VA/DoD Clinical Practice Guideline for PTSD (2023)](https://www.healthquality.va.gov/guidelines/mh/ptsd/): Lists EMDR among strongly recommended treatments for PTSD
