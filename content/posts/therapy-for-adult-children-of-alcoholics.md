...
slug: "therapy-for-adult-children-of-alcoholics"
affiliate_disclosure: true
faqs:
 - q: "How is ACA therapy different from regular trauma therapy?"
   a: "ACA therapy specifically addresses chronic, relational childhood trauma rather than acute events, and it targets the particular belief patterns and interpersonal dynamics that form in alcoholic households. A therapist familiar with the ACA profile will recognize things like hypervigilance, caretaking, and difficulty with self-trust as systemic adaptations rather than individual quirks, which changes both how they're named and how they're treated."
 - q: "Do I need to have a 'bad enough' childhood to benefit from therapy?"
   a: "No, and this framing is itself an ACA pattern. Minimizing your experience to avoid seeming dramatic is exactly the kind of distorted self-perception therapy addresses. If your parent's drinking affected the household's emotional climate, your nervous system registered it, whether or not there were dramatic incidents to report."
 - q: "Is Al-Anon the same as ACA therapy?"
   a: "They're different but not competing. Al-Anon is a peer support program based on 12-step principles, free and widely available. Therapy is a clinical intervention with a trained professional. Many people find both useful at different stages. Al-Anon tends to be more accessible as a first step; clinical therapy goes deeper into the specific patterns formed in childhood."
 - q: "How long does therapy for ACAs typically take?"
...
The specific thing group provides that individual therapy structurally can't: you get to see your patterns in real time, reflected back by other people who share your history. When six people in a room all recognize the same response you just described, the shame around it shifts. Al-Anon has been running groups for people affected by others' drinking since 1951, and it remains a meaningful resource, especially for people who aren't ready for formal clinical therapy. The [National Alliance on Mental Illness (NAMI)](https://www.nami.org/) also offers support groups that are free and accessible across the country, which matters given that therapy access is genuinely uneven.
...
If you're in crisis while doing this work, or if things get harder before they get easier (common, and worth naming), the [988 Suicide and Crisis Lifeline](https://988lifeline.org/) is available by call or text around the clock.
