...
For anyone in crisis right now: the [988 Suicide and Crisis Lifeline](https://988lifeline.org/) is available by call or text, 24 hours a day. Not just for suicidal crises. For moments when you're overwhelmed and need to talk to someone trained to help before you can get connected to ongoing care.
...
Structured workbooks can be meaningful, particularly ones grounded in Cognitive Behavioral Therapy (CBT). "Mind Over Mood" by Christine Padesky and Dennis Greenberger has been in print since 1995 and is consistently recommended by therapists themselves as a between-sessions tool. You can find it on [Amazon](https://amzn.to/3Q5v0EV) for around $20 (note: this site may earn a small commission from qualifying purchases). It's not a replacement for therapy, and I'd never frame it that way. But it's a real resource, not just a self-help book.

Mindfulness practices also have a decent evidence base for anxiety and stress, specifically. Apps like Insight Timer are free and genuinely functional. A ten-minute guided session won't resolve what you're carrying, but it can lower your baseline enough to make the search feel less overwhelming.
