---
title: "Partial Hospitalization Programs: Mental Health Care Without Overnight Stay"
date: 2026-07-28T15:52:39.013676+00:00
draft: false
description: "Learn how partial hospitalization programs provide intensive mental health treatment during the day while allowing patients to return home at night."
image: "/img/heroes/5699454.jpg"
categories: ["Level of Care"]
tags: ["what", "partial", "hospitalization", "program", "mental"]
...
slug: "what-is-a-partial-hospitalization-program-for-mental-health"
affiliate_disclosure: true
faqs:
  - q: "How is a PHP different from an IOP?"
    a: "The primary difference is time. Intensive Outpatient Programs (IOP) run about 3 hours per day, three to five days a week. PHP programs run 5-6 hours per day and are considered a higher level of clinical intensity. PHP typically includes more frequent psychiatric oversight and is suited for more acute symptom presentations."
  - q: "Can I work or go to school while in a PHP?"
    a: "Realistically, it's difficult. A full PHP schedule runs most of the morning and into early afternoon, leaving limited time for work or classes. Some people take short-term leave through FMLA or a similar accommodation, and many HR departments are more flexible than people expect when mental health treatment is framed clearly. It's worth having that conversation rather than assuming."
  - q: "Do I have to be hospitalized first to get into a PHP?"
    a: "No. This is one of the most common misconceptions. A referral from an outpatient psychiatrist, therapist, or even a primary care provider is enough to start the intake process at most PHP programs. You don't have to hit a crisis point that requires hospitalization to qualify."
  - q: "How long does a PHP program last?"
    a: "Most programs run two to six weeks, with the average closer to three to four weeks for adults. The exact length depends on your progress, your insurance authorization (which is reviewed periodically), and the clinical team's assessment. Some people step down to IOP after two weeks; others need the full six."
  - q: "What happens after PHP ends?"
    a: "Most programs build a step-down plan before you discharge. The typical pathway is PHP to IOP (three days a week, three hours a day) and then to standard outpatient therapy. That transition is intentional; the goal is to reduce intensity gradually rather than going from full-day programming back to nothing, which can leave people vulnerable. Ask your program about the discharge plan on day one, not the last day."
---

Most people find out what a [partial hospitalization program](/partial-hospitalization-program-explained/) is the hard way: a psychiatrist or social worker mentions it at the end of a crisis appointment, throws out an acronym (PHP), and suddenly you're sitting in a parking lot Googling something you've never heard of while still shaking from whatever just happened in that office.
...
Here's what I want you to understand before we go any further: a partial hospitalization program isn't a lesser version of inpatient treatment. For many people, it's exactly the right amount of structure. And knowing the [difference between](/difference-between-psychologist-psychiatrist-and-therapist/) PHP and your other options could save you months of struggling through the wrong level of care.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">PHP typically runs 5-6 hours per day, 4-5 days per week, for 2-6 weeks on average.</li><li style="margin:5px 0">It's more intensive than outpatient therapy but lets you sleep at home each night.</li><li style="margin:5px 0">PHP costs roughly $300-$800 per day; most major insurers are required to cover it.</li><li style="margin:5px 0">It treats conditions like major depression, bipolar disorder, severe anxiety, and eating disorders.</li><li style="margin:5px 0">You don't need a hospitalization to qualify ,  a referral from a psychiatrist or therapist is usually enough.</li></ul></div>


## What Actually Happens in a PHP

Think of it as a structured day program. You show up in the morning, usually around 8 or 9 a.m., and you're there until early afternoon, sometimes 3 p.m. During that time, you're doing a combination of group therapy, individual therapy sessions, psychiatric [medication management](/psychiatrist-medication-management/), and skills-based work like CBT or DBT. Then you go home.
...
| Level of Care | Hours Per Day | Overnight Stay | Weekly Time Commitment | Typical Duration |
|---|---|---|---|---|
| Outpatient therapy | 1 hour | No | 1-2 hours | Months to years |
| Intensive Outpatient (IOP) | 3 hours | No | 9-15 hours | 6-12 weeks |
| Partial Hospitalization (PHP) | 5-6 hours | No | 20-30 hours | 2-6 weeks |
| Residential treatment | 24 hours | Yes (facility) | All day, every day | 30-90+ days |
| Inpatient psychiatric | 24 hours | Yes (hospital) | All day, every day | 3-14 days typically |
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Typical PHP daily hours by program type</div><div class="sc-row"><span class="sc-label">General adult PHP</span><span class="sc-track"><span class="sc-bar" style="width:79%"></span></span><span class="sc-val">5.5 hrs/day</span></div><div class="sc-row"><span class="sc-label">Adolescent PHP</span><span class="sc-track"><span class="sc-bar" style="width:86%"></span></span><span class="sc-val">6 hrs/day</span></div><div class="sc-row"><span class="sc-label">DBT-focused PHP</span><span class="sc-track"><span class="sc-bar" style="width:86%"></span></span><span class="sc-val">6 hrs/day</span></div><div class="sc-row"><span class="sc-label">Eating disorder PHP</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">7 hrs/day</span></div><div class="sc-row"><span class="sc-label">Dual diagnosis PHP</span><span class="sc-track"><span class="sc-bar" style="width:71%"></span></span><span class="sc-val">5 hrs/day</span></div><div class="sc-src">Source: Taylor Brooks, based on industry program data 2026</div></div>
...
- [National Alliance on Mental Illness (NAMI)](https://www.nami.org/): Overview of psychiatric care levels including PHP, step-down care frameworks
...
- [Psychology Today Therapist Finder](https://www.psychologytoday.com/us/therapists): Searchable directory of PHP programs and treatment centers by location and specialty
