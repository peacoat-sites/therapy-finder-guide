---
title: "What LMFTs Do: Skills You Need to Know"
date: 2026-08-16T13:55:11.207112+00:00
draft: false
description: "Learn what licensed marriage and family therapists do, their qualifications, and how they help couples and families resolve conflicts and strengthen relationshi"
image: "/img/heroes/7176286.jpg"
categories: ["Finding Help"]
tags: ["licensed", "marriage", "family", "therapist", "lmft"]
...
slug: "licensed-marriage-family-therapist-lmft"
affiliate_disclosure: true
faqs:
  - q: "Can an LMFT diagnose mental health conditions?"
    a: "Yes. Licensed Marriage and Family Therapists are trained to assess and diagnose mental health conditions using the DSM-5 in most states. However, they cannot prescribe medication, so if medication is part of your treatment, you'll need a psychiatrist or psychiatric nurse practitioner as well."
  - q: "Is there a difference between marriage counseling and couples therapy with an LMFT?"
    a: "Technically yes. 'Marriage counseling' often refers to shorter-term, advice-oriented work, sometimes through religious or community organizations with no clinical licensure required. Couples therapy with a licensed LMFT is clinically structured, often follows an evidence-based model like Gottman or EFT, and involves a trained clinician who can also address underlying mental health issues affecting the relationship."
  - q: "How long does therapy with an LMFT usually take?"
    a: "It genuinely depends on what you're working on. Short-term solution-focused work might wrap up in 8 to 12 sessions. Deeper relational or trauma work can continue for a year or more. Most therapists will give you a rough sense of the expected timeframe after the first one to two sessions."
  - q: "Does insurance cover LMFT sessions?"
    a: "Many insurance plans do cover LMFT sessions, but coverage varies significantly. As of 2026, most major commercial insurers recognize LMFTs as covered providers for 'outpatient psychotherapy.' Couples therapy specifically can be trickier to get covered because it may require a mental health diagnosis attached to a specific individual. Always verify with your insurance before your first appointment."
  - q: "What should I ask an LMFT before starting therapy?"
    a: "Ask about their specific training and the models they use (Gottman, EFT, IFS, CBT, etc.), their experience with your particular issue, their cancellation policy, and how they handle it if you feel like things aren't working. A good therapist welcomes that last question; it's actually a sign of a healthy therapeutic stance."
---

Most people who end up calling an LMFT for the first time spent at least six months telling themselves they didn't need to. I know because I watched it happen repeatedly, sitting in on intake calls during my years working alongside a group practice. The person on the phone has usually tried journaling, tried talking to friends, maybe tried a couples retreat they saw advertised on Instagram. By the time they're dialing, they've already been through enough that the question isn't really "do I [need therapy](/signs-you-might-need-therapy/)" anymore. It's "what kind, and who exactly do I call?"
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">LMFTs specialize in relational and systemic therapy, not just individual mental health treatment.</li><li style="margin:5px 0">They complete 3,000+ supervised clinical hours before licensure in most U.S. states.</li><li style="margin:5px 0">LMFTs can treat individuals, couples, families, and children, despite the name suggesting otherwise.</li><li style="margin:5px 0">Session costs range roughly $100-$250 out of pocket; many accept insurance as of 2026.</li><li style="margin:5px 0">An LMFT is often the better choice over a general therapist for relationship conflict, divorce, or family dynamics issues.</li></ul></div>
...
I get this question more than almost any other: "What's the actual [difference between](/difference-between-psychologist-psychiatrist-and-therapist/) an LMFT and an LCSW or an LPC?"
...
| Credential | Full Title | Training Focus | Can Prescribe Meds? | Typical Specialty |
|---|---|---|---|---|
| LMFT | Licensed Marriage and Family Therapist | Relational/systemic therapy | No | Couples, families, relational issues |
| LCSW | Licensed Clinical Social Worker | Social systems, case management, clinical therapy | No | Trauma, crisis, individual therapy |
| LPC / LPCC | Licensed Professional Counselor | Individual counseling, CBT, behavioral approaches | No | Anxiety, depression, career issues |
| PhD / PsyD | Psychologist | Assessment, research, advanced clinical therapy | No (in most states) | Complex diagnoses, neuropsych testing |
| Psychiatrist | Medical Doctor (MD/DO) | Diagnosis and medication management | Yes | Medication, severe mental illness |
...
As of August 2026, out-of-pocket rates for an LMFT session typically land somewhere between $100 and $250 per hour, depending on location, the therapist's experience level, and whether they're in private practice or a group setting. Therapists in major metro areas like New York, Los Angeles, or Seattle tend to be at the higher end of that band. Therapists in smaller markets or those offering telehealth-only practices often charge less.
...
If cost is a real barrier, the [National Alliance on Mental Illness (NAMI)](https://www.nami.org/) maintains a helpline and resource directory that can point you toward community mental health centers where fees are income-based.
...
For acute mental health crises, please don't wait for a therapy appointment. The [988 Suicide and Crisis Lifeline](https://988lifeline.org/) is available 24/7 by call or text, and it's one of the better-designed crisis resources in the current system.
...
- *The Anxiety and Worry Workbook* by Clark and Beck is a structured CBT resource that pairs well with therapy (available on [Amazon](https://www.amazon.com/dp/1606239902?tag=contentportfo-20), roughly $22; note the site may earn a small commission on purchases through this link).
...
- [AMFTRB (Association of Marital and Family Therapy Regulatory Boards)](https://www.amftrb.org/): Official body for LMFT licensure standards and examination requirements across U.S. states.
- Flückiger, C., Del Re, A.C., Wampold, B.E., & Horvath, A.O. (2018): "The alliance in adult psychotherapy: A meta-analytic synthesis." *Psychotherapy*, 55(4), 316-340.
- [National Alliance on Mental Illness (NAMI)](https://www.nami.org/): Helpline, resource directory, and policy information for mental health care access.
- [Psychology Today Therapist Directory](https://www.psychologytoday.com/us/therapists): Searchable national database with credential and specialty filters.
- [American Association for Marriage and Family Therapy (AAMFT)](https://www.aamft.org/): Professional organization defining LMFT scope of practice and training standards.
