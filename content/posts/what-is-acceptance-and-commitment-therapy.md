---
title: "Acceptance and Commitment Therapy: How ACT Works"
date: 2026-07-20T15:34:11.544330+00:00
draft: false
description: "Learn how acceptance and commitment therapy helps you build psychological flexibility and live by your values despite difficult thoughts and emotions."
image: "/img/heroes/2035102.jpg"
categories: ["Therapy Types"]
tags: ["what", "acceptance", "commitment", "therapy"]
...
faqs:
  - q: "Is ACT the same as mindfulness therapy?"
    a: "ACT uses mindfulness as one of its six core processes, but it's not the same thing. Mindfulness-Based Cognitive Therapy (MBCT) and Mindfulness-Based Stress Reduction (MBSR) are distinct programs. ACT integrates present-moment awareness alongside values clarification and behavioral commitment in a way those programs don't."
  - q: "How long does ACT take to work?"
    a: "Most structured ACT protocols run 8-16 sessions, with many people noticing meaningful shifts in psychological flexibility by weeks 6-8. Chronic pain, OCD, and trauma presentations typically require longer. As of 2026, telehealth has made it easier to access ongoing sessions without the gaps that used to interrupt progress."
  - q: "Can ACT be done online or through an app?"
    a: "Yes, and the evidence for digital ACT delivery is growing. Apps like Woebot incorporate some ACT elements, though they're not a substitute for a trained therapist in complex cases. A therapist doing ACT via video call is functionally equivalent to in-person for most presentations."
  - q: "Is ACT covered by insurance?"
    a: "Usually yes, because ACT is delivered by licensed therapists billing under standard psychotherapy codes. What your plan covers depends on your specific benefits. The therapy modality isn't what's billed; the session type is. Call your insurer and ask about outpatient mental health benefits, not 'ACT specifically.'"
  - q: "Who is ACT not right for?"
    a: "ACT requires some capacity to engage in abstract thinking and self-reflection, which makes it less suitable for people in acute psychosis or severe cognitive impairment. People with significant dissociation may need modified approaches to the mindfulness components. It's not the first-line recommendation for acute PTSD without trauma-specific adaptation."
---

Most people who ask me about ACT have already tried something else. They've done a round of CBT, maybe read a self-help book or two, possibly spent six months in [talk therapy](/how-does-talk-therapy-change-the-brain/) that felt like circling the same drain. They come in curious but a little guarded: "Is this just going to tell me to think positive thoughts again?" Honestly, I get it. And the answer is no. ACT is almost the opposite of that.

Acceptance and Commitment Therapy (usually pronounced like the word "act," not the letters) is a [behavioral therapy](/cognitive-behavioral-therapy-explained/) developed by psychologist Steven Hayes in the late 1980s. Hayes wasn't trying to build a shinier version of CBT. He was questioning a foundational assumption that most Western psychology had been running on: that psychological suffering is caused by distorted thinking, and that if we fix the thinking, we fix the person. ACT says something more uncomfortable. It says that trying to control, suppress, or eliminate unwanted thoughts and feelings is often what keeps people stuck. The goal isn't to feel better. It's to live better, even when you feel terrible.

That distinction matters more than it might sound.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">ACT is an evidence-based therapy that teaches psychological flexibility, not positive thinking or thought elimination.</li><li style="margin:5px 0">Six core processes (defusion, acceptance, present-moment awareness, self-as-context, values, committed action) form its foundation.</li><li style="margin:5px 0">A 2012 meta-analysis of 39 randomized controlled trials found ACT outperformed control conditions across anxiety, depression, chronic pain, and addiction.</li><li style="margin:5px 0">Sessions typically run 8-16 weeks, though chronic pain and trauma presentations often run longer.</li><li style="margin:5px 0">ACT works alongside medication and is commonly used when other therapies have plateaued.</li></ul></div>
...
| Therapy | Core assumption | Goal | Typical length | Homework? |
|---|---|---|---|---|
| CBT | Distorted thoughts cause distress | Change thought patterns | 12-20 sessions | Yes, structured |
| ACT | Struggle with thoughts causes distress | Build psychological flexibility | 8-16 sessions | Yes, experiential |
| DBT | Emotion dysregulation drives behavior | Regulate emotions + accept reality | 6 months to 1 year | Yes, intensive |
| Psychodynamic | Past shapes present | Insight into unconscious patterns | Months to years | Less formal |
| EMDR | Trauma memories are unprocessed | Reprocess traumatic memories | 3-12 sessions | Moderate |
...
If you're trying to find an ACT therapist, SAMHSA's treatment locator at [findtreatment.gov](https://findtreatment.gov/) can help you identify licensed providers in your area, and many now offer telehealth.
...
A workbook won't replace a therapist if you're dealing with moderate-to-severe depression, suicidal ideation, trauma, or an eating disorder. If you're in crisis right now, please reach out to the [988 Suicide and Crisis Lifeline](https://988lifeline.org/) by calling or texting 988.
...
- [SAMHSA's treatment locator](https://findtreatment.gov/): Official U.S. resource for finding licensed mental health and substance use providers.

---


*Photo: [Lucas Pezeta](https://www.pexels.com/@lucaspezeta) via Pexels*
