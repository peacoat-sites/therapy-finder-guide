...
slug: "therapy-for-addiction"
affiliate_disclosure: true
faqs:
  - q: "Is therapy alone enough to treat addiction?"
    a: "It depends on the substance and the severity. For alcohol and stimulant use disorders, therapy (especially CBT) can be highly effective on its own. For opioid use disorder, the research strongly supports combining therapy with medication. Relying on therapy alone for opioids puts people at significantly higher risk of relapse and overdose."
  - q: "How long does addiction therapy usually take?"
    a: "There's no standard timeline, and anyone who gives you one without assessing your specific situation is guessing. Short-term Motivational Interviewing might run 4 to 8 sessions. An outpatient CBT program might be 12 to 20 sessions. Many people in recovery continue some form of ongoing support for years, not because they're failing, but because maintenance matters."
  - q: "Can I do therapy online for addiction?"
    a: "Yes, and current research (including studies published since telehealth expanded post-2020) suggests outcomes are comparable to in-person for outpatient addiction therapy in most cases. The exception is if you need medical monitoring or intensive programming, where in-person is typically required. Platforms that connect you with licensed addiction-specialized therapists have improved considerably."
  - q: "What's the difference between a therapist and a counselor for addiction?"
...
This is where things get frustrating, so I'll cut right to the useful part.
...
[SAMHSA's treatment locator at findtreatment.gov](https://findtreatment.gov/) is genuinely the most efficient place to start for finding licensed programs and providers in your area. Filter by "outpatient," by substance type, and by whether they offer MAT. It's not perfect, some listings are outdated, but it's the most comprehensive database available in the U.S. and it's free.

[Psychology Today's therapist directory](https://www.psychologytoday.com/us/therapists) is useful for finding individual therapists and lets you filter by "substance use" as a specialty. The profiles also show insurance accepted, which saves a lot of phone tag.
...
- [JAMA Psychiatry (2019)](https://jamanetwork.com/journals/jamapsychiatry): Meta-analysis of CBT efficacy across substance use disorders, 400+ randomized trials reviewed
- [Drug and Alcohol Dependence (Prendergast et al., 2006)](https://www.sciencedirect.com/journal/drug-and-alcohol-dependence): Meta-analysis on Contingency Management showing approximately double abstinence rates vs. standard counseling for stimulant use
- [National Institute on Drug Abuse (NIDA)](https://nida.nih.gov): Research summaries on buprenorphine retention rates and MAT outcomes for opioid use disorder
- [SAMHSA Treatment Locator](https://findtreatment.gov/): Official U.S. government database for licensed substance use and mental health treatment programs
- [American Society of Addiction Medicine (ASAM)](https://www.asam.org): Clinical practice guidelines on MAT and evidence-based treatment standards, current as of July 2026
